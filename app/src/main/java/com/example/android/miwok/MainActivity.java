...
public class MainActivity extends AppCompatActivity {
    ...
    implicit for communicating with other apps
    explicit for communicating within the app as a rule of thumb
    here explicit, so we are sure that a specific activity gets launched
     */

    //dont forget to pass a view ind the ()
    /*
